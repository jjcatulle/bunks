            ...
            <div className="section mb-5">
                <div className="px-4 pt-1 pb-4 mt-1 mb-4 text-center">
                    ...
                    <div className="col-lg-6 mx-auto">
                        <p className="lead mb-4">As Black History Month approaches and Black People remain underrepresented in the NFT space, we embarked on a mission to revolutionize the world’s view of NFT’s. (The next 1000 are Free!)</p>
